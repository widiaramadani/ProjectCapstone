    ...
    <div id="heroCarousel" class="carousel slide hero-carousel" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img src="https://t4.ftcdn.net/jpg/09/08/40/25/360_F_908402556_bQH5udqPgjPrF5eV7QysU98iH5oGkCeR.jpg" alt="Nopia Special">
            ...
            <div class="carousel-item">
                <img src="https://asset.kompas.com/crops/QIZTHaixdhxnSIpRrWlMdVgqK-8=/0x0:1000x667/1200x800/data/photo/2023/02/25/63f903a8a7d32.jpg" alt="Varian Baru">
                <div class="carousel-overlay">
                    <div class="carousel-content">
                        <h1 class="display-3 fw-bold mb-4">Nopia Gula Aren</h1>
            ...
            <!-- Slide 3 -->
            <div class="carousel-item">
                <img src="https://image.idntimes.com/post/20250202/1686899245-adwi-desa-wisata-pekunden-69-jpg-59f506aa441e3192bb4237a4e87b2a36-67f4c73ed3d2cbbb5aed7f87462250ef.jpg" alt="Proses Pembuatan">
                <div class="carousel-overlay">
                    <div class="carousel-content">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6">
                    <div class="category-card">
                        ...
                        <div class="category-name">Nopia Durian</div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="category-card">
                        ...
                        <div class="category-name">Nopia Gula Aren</div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="category-card">
                        ...
                        <div class="category-name">Nopia Pandan</div>
                        <div class="category-count">2 Items</div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="category-card">
                        ...
                        <div class="category-name">Paket Mix </div>
                        <div class="category-count">3 Items</div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 border-0 shadow-sm rounded-4">
                        <div class="position-relative">
                            <img src="https://down-id.img.susercontent.com/file/id-11134207-7rasg-m27vk8v4whj73b" class="card-img-top" alt="Nopia Original" style="height: 250px; object-fit: cover;">
                        </div>
                        <div class="card-body p-4">
                            <h5 class="card-title fw-bold mb-3">Mini Nopia Pandan</h5>
                            <p class="card-text text-secondary mb-3">Cita rasa yang harum dan lembut khas dari pandan</p>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <p class="fs-4 fw-bold mb-0 text-brown">Rp 15.000</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 border-0 shadow-sm rounded-4">
                        <div class="position-relative">
                            <img src="https://assets.radarpekalongan.id/main/2023/09/Nopia-kue-khas-Banyumas-720x675.webp" class="card-img-top" alt="Nopia Keju" style="height: 250px; object-fit: cover;">
                        </div>
                        <div class="card-body p-4">
                            <h5 class="card-title fw-bold mb-3">Nopia Durian</h5>
                            <p class="card-text text-secondary mb-3">Perpaduan pas antara tradisi dan kenikmatan rasa khas buah durian</p>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <p class="fs-4 fw-bold mb-0 text-brown">Rp 15.000</p>
                                <div class="text-warning">
                                    <i class="bi bi-star-fill"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 border-0 shadow-sm rounded-4">
                        <div class="position-relative">
                            <img src="https://foodnesia.net/wp-content/uploads/2019/12/kue-nopia-khas-purbalingga-mantap.jpg" class="card-img-top" alt="Nopia Coklat" style="height: 250px; object-fit: cover;">
                        </div>
                        <div class="card-body p-4">
                            <h5 class="card-title fw-bold mb-3">Mini Nopia Gula Aren</h5>
                            <p class="card-text text-secondary mb-3">Varian Gula Aren yang kaya rasa, favorit anak-anak dan dewasa</p>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <p class="fs-4 fw-bold mb-0 text-brown">Rp 15.000</p>
                                <div class="text-warning">
                                    <i class="bi bi-star-fill"></i>
