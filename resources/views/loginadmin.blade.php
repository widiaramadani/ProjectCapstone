...
<body>
        ...
        <div class="login-container">
            ...
            <form id="loginForm" onsubmit="handleLogin(event)">
                <div class="form-group">
                    <label for="username">Silahkan Masuk</label>
    ...
    <script>
        function handleLogin(event) {
            ...
            // Simulasi validasi login (ganti dengan validasi sebenarnya)
            // Untuk contoh: username: admin, password: admin123
